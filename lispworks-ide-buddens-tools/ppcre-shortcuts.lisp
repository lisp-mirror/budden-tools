...
; áåçîïàñíûé èäåíòèôèêàòîğ ëèñïà - âíóòğåííèé èëè êâàëèôèöèğîâàííûé âíåøíèé ñèìâîë. 
; FIXME - êîãäà-íèáóäü çàïğåòèòü íåêâàëèôèöèğîâàííûå ñèìâîëû
(define-parse-tree-synonym safe-lisp-identifier
                           (:sequence 
                            (:regex "[a-zA-Z_àáâãäå¸æçèéêëìíîïğñòóôõö÷øùúûüışÿÀÁÂÃÄÅ¨ÆÇÈÉÊËÌÍÓÏĞÑÒÓÔÕÖ×ØÙÚÛÜİŞß\\-0-9]*")

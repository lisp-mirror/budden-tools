...
(def-merge-packages::! :КАРТЫ-ИСХОДНИКОВ-ЛИЦО
  ...
  (:export
   "
    ...
    КАРТЫ-ИСХОДНИКОВ-ЛИЦО:output-stream-position-in-chars
    ...
    КАРТЫ-ИСХОДНИКОВ-ЛИЦО:|Очистить-карту-исходников-для-файлов-зпт-похожих-на-сгенерированные-из-данного|
    ...
    КАРТЫ-ИСХОДНИКОВ-ЛИЦО:|Сохранить-карту-для-файла-в-файл|
    КАРТЫ-ИСХОДНИКОВ-ЛИЦО:SLO-SOURCE-В-ИМЯ-ФАЙЛА
    "
   ))
...
;; see-packages and friends
   ...
   budden-tools:*fn-before-return-symbol-from-reader-hook* ; работает в паре с :buddens-reader
...
(def-merge-packages::! :БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО
  (:always t)
  (:nicknames :БУКВЫ-И-МЕСТА-В-ФАЙЛЕ) ; ПРАВЬМЯ - убрать это
  (:use :cl :budden-tools)
  (:export
   "
    ;;Строка-редактора-и-её-номер
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Строка-редактора-и-её-номер|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|MAKE-Строка-редактора-и-её-номер|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Строка-редактора-и-её-номер-P|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|COPY-Строка-редактора-и-её-номер|
    
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Строка-редактора-и-её-номер-Номер|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Строка-редактора-и-её-номер-LINE|

    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Место-в-исходнике|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Место-в-исходнике-Источник|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Место-в-исходнике-Строка|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Место-в-исходнике-Колонка|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Место-в-исходнике-ПБу|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Место-в-исходнике-Кнф|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|MAKE-Место-в-исходнике|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|COPY-Место-в-исходнике|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Место-в-исходнике-Номер-строки|

    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|MAKE-Пб|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Пб|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Пб-P|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Пб-Бу|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Пб-По|

    ;;Ссылка-на-источник
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Ссылка-на-источник|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|MAKE-Ссылка-на-источник|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Ссылка-на-источник-P|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|COPY-Ссылка-на-источник|
    
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Ссылка-на-источник-Тип|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Ссылка-на-источник-Данное|

    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Тип-ссылки-на-источник|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Тсни-файл|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Тсни-строка| 
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Тсни-буфер-редактора|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Тсни-информация-утрачена|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Тсни-неведомо-что|
    
    ;; Утилиты
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Обработать-Пб-По-для-вставки-в-исходный-текст|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Сдвинуться-на-несколько-литер|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Сдвинуться-на-одну-литеру-вправо-если-не-КНФ|
    БУКВЫ-И-МЕСТА-В-ФАЙЛЕ-ЛИЦО:|Место-в-исходнике-<=|
    ")
  )

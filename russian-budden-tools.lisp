...
; однако, выяснилось, что echo - это команда из gnuwin32, а не из windows. 
; она отсутствует на других серверах. Поэтому определяем преобразование по образцу.
(BUDDEN-TOOLS:def-toplevel-progn "dos-string-to-lisp-and-vice-versa" ()
    (unless (fboundp (find-symbol "DOS-STRING-TO-LISP" :RUSSIAN-BUDDEN-TOOLS))
      (eval #+nil '(russian-budden-tools::define-open-pipe-character-translators)

...
#|
Что у нас плохого?
1. Есть другие аналогичные структуры:
 BUDDEN-TOOLS:ROW-COL-OFFSET 
 ПОЛНОСТЬЮ-КЕШИРОВАННЫЙ-ПОТОК:|Место-в-исходнике|

, к-рую надо бы привести к этому виду. КРоме того, SBCL как-то должен уметь считать строки.
...
КАРТЫ-ИСХОДНИКОВ-ЛИЦО:fix-offset-2

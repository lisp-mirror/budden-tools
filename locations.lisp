...
Можно попробовать изменить работу с потоками с помощью gray streams.
Прорастить класс от каждого потока и делать change-class, 
когда выполняется данная операция. В примитивах вывода тогда будем
проводить операции над картами. 

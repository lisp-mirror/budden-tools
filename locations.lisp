...
(defun |Что-порождено-из-этого-места| (|Ссылка-на-источник| |Смещение|)
  ...
  (perga
   (let |Находки| nil)
   (flet |Искать-в-одной-таблице| (|Ссылка-на-генерированный-код| |Карта|)
     (_f append |Находки|
         (|Искать-порождённые-исходники-в-одной-карте|
          |Ссылка-на-источник| |Смещение|
          |Ссылка-на-генерированный-код| |Карта|)))
   (maphash #'|Искать-в-одной-таблице| *nplf)
   |Находки|))


(defun |Искать-порождённые-исходники-в-одной-карте| (|Ссылка-на-источник| |Смещение| |Ссылка-на-генерированный-код| |Карта|)
   ...
   (etypecase |Карта|
     ...
     (slo
      ...
      (when 
        ...
        (list (list |Ссылка-на-генерированный-код| (+ |Смещение| (- |Начало-диапазона-исходного-текста-в-карте|) 1)))))
     (ses
      (let |Находки| nil)
      (let |Исходники| (ses-sources |Карта|))
      (dolist (И |Исходники|)
        (_f append |Находки| (|Искать-порождённые-исходники-в-одной-карте| |Ссылка-на-источник| |Смещение| |Ссылка-на-генерированный-код| И)))
      |Находки|)
     (olm
      (let |Находки| nil)

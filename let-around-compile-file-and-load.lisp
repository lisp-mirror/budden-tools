...
(defparameter *СПИСОК-ПЕРЕМЕННЫХ-ДЛЯ-СВЯЗЫВАНИЯ-ВОКРУГ-LOAD-И-COMPILE-FILE* nil "Список переменных, к-рые будут связаны своими значениями вокруг compile-file и load")
